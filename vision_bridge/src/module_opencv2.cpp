...
#define ERRWRAP2(expr) \
  ...
  catch (const vision::Exception & e) \
  { \
...
class NumpyAllocator : public vision::MatAllocator
{
public:
  NumpyAllocator() {}
  ~NumpyAllocator() {}
...
int convert_to_VisionMat2(const PyObject * o, vision::Mat & m)
{
  ...
  m = vision::Mat(ndims, size, type, PyArray_DATA(reinterpret_cast<PyArrayObject *>(o)), step);
